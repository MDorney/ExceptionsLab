...
public class Employee {
    ...
    public final void setDaysVacation(int daysVacation) throws IllegalArgumentException {
        if (daysVacation < 0 || daysVacation > 30){
            throw new IllegalArgumentException("This is outside the range of allowed vacation days (0-30)");
        }
    ...
    public final void setSsn(String ssn) {        
        if (ssn.length() != 9) {
            throw new IllegalArgumentException("Sorry, that is not a valid format for SS Number");
        }
        this.ssn = ssn;
    }
